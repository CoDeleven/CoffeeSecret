...
import com.dhy.coffeesecret.ui.bake.BeanChoiceActivity;
import com.dhy.coffeesecret.ui.bake.adapter.BeanSelectAdapter;
...
public class BakeDialog extends DialogFragment implements BeanSelectAdapter.MyButtonOnClick {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(bundle != null){
            beanInfos = bundle.getParcelableArrayList(UniExtraKey.EXTRA_BAKE_REPORT_LIST.getKey());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            ...
            BakeReport bakeReport =  data.getParcelableExtra(UniExtraKey.EXTRA_BAKE_REPORT.getKey());
            if (beanInfo != null) {
    ...
    public void onNameClick(int position) {
        curItem = position;
        Intent intent = new Intent(mContext, BeanChoiceActivity.class);
