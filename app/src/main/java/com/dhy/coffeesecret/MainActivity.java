...
import com.dhy.coffeesecret.ui.mycontainer.MyContainerFragment;
import com.dhy.coffeesecret.ui.mycup.MyCupFragment;
import com.dhy.coffeesecret.ui.mydevice.MyDeviceFragment;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity implements MyDeviceFragment.OnDeviceInteractionListener,
        MyContainerFragment.OnContainerInteractionListener, MyCupFragment.OnCupInteractionListener{
    ...
    private void initParam(){
        ...
        mFragments.add(new MyContainerFragment());
        mFragments.add(new MyCupFragment());
