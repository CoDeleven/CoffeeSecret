...
import cniao5.com.cniao5shop.utils.UIUtils;
...
public class WareListActivity extends AppCompatActivity implements Pager.OnPageListener<Wares>, TabLayout.OnTabSelectedListener, View.OnClickListener {
    ...
    private void initView() {
        ...
        mTxtSummary = find(R.id.txt_summary);
        mRecyclerview_wares = find(R.id.recyclerview_wares);
        mRefreshLayout = find(R.id.refresh_layout);
    ...
    private void initToolBar() {
        mToolbar.setRightButtonIcon(R.drawable.ic_apps);
        mToolbar.getRightImage().setTag(ACTION_LIST);
    ...
    public void onClick(View v) {
        ...
        if (ACTION_LIST == action) {
            mToolbar.setRightButtonIcon(R.drawable.ic_list);
            mToolbar.getRightImage().setTag(ACTION_GIRD);
            ...
            mToolbar.setRightButtonIcon(R.drawable.ic_apps_white_36dp);
            mToolbar.getRightImage().setTag(ACTION_LIST);
